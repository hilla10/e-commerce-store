import { getDatesInRange } from '../controllers/analyticsController.js';
...
export const getDailySalesData = async (startDate, endDate) => {
  try {
    ...
    // [
    //{ _id: '2023-06-01', sales: 2, revenue: 100 },
    // { _id: '2023-06-02', sales: 1, revenue: 50 }
    // ]

    const dateArray = getDatesInRange(startDate, endDate);

    //   console.log(dateArray); // ['2025-10-22','2025-10-23',...]
